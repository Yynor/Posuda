...
public partial class RegWindow : Window
{
        ...
        if(UserConfirmPasswordBox.Text == UserPasswordBox.Text)
        {
            ...
            { 
                try{
                    ...
                    MySqlCommand command = new MySqlCommand("INSERT INTO Users (LastName, FirstName, MiddleName, Login, Password, RoleID) VALUES (@surname, @name, @patronymic, @login, @password, @role)", connection);
    ...
    private void PwdShowCheckBox_Checked(object sender, RoutedEventArgs e)
    {
            UserConfirmPasswordBox.RevealPassword = true;
    }
     private void PwdShowCheckBox_Unchecked(object sender, RoutedEventArgs e)
    {
        UserConfirmPasswordBox.RevealPassword = false;
    }
